...
namespace MRTKExtensions.QRCodes
{
    public class SpatialGraphCoordinateSystemSetter : MonoBehaviour
    {
        ...
        private void UpdateLocation(Guid spatialGraphNodeId, float physicalSideLength)
        {
            ...
            //newMatrix = (System.Numerics.Matrix4x4) transform.worldToLocalMatrix;
            ...
            // move the anchor point to the *bottom right* of the qr code
            var sideLength = physicalSideLength;
            pose.position += (pose.rotation * ((5.5f * sideLength) * Vector3.right) - // right
                              pose.rotation * (sideLength * Vector3.up) - // down
                              pose.rotation * (0.023f * Vector3.forward)); // into wall
